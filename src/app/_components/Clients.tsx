...
export function Clients() {
  ...
  return (
    <div className="space-y-8 py-24 bg-[#1F3A44] relative overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-t from-transparent via-[#FFC300]/5 to-transparent pointer-events-none" />
      <div className="absolute top-20 right-10 w-72 h-72 rounded-full bg-[#FFC300]/10 blur-3xl opacity-40" />
      <div className="absolute bottom-20 left-10 w-96 h-96 rounded-full bg-[#00B5AD]/10 blur-3xl opacity-40" />

      <div className="mx-auto flex w-full max-w-screen-lg flex-col items-center space-y-8 px-4 relative z-10">
        <div className="text-center space-y-4">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#FFC300]/10 border border-[#FFC300]/20 mb-4">
            <Sparkles className="w-4 h-4 text-[#FFC300]" />
            <span className="text-sm font-medium text-white">{t.clients.badge}</span>
          </div>

          <h2 className="hero-title text-4xl md:text-5xl lg:text-6xl text-white mb-4">
            {t.clients.title}
          </h2>
