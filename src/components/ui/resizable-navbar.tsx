...
export const NavBody = ({ children, className, visible }: NavBodyProps) => {
  return (
    <motion.div
      ...
      className={cn(
        "relative z-[60] mx-auto hidden w-full max-w-7xl flex-row items-center justify-between self-start rounded-full bg-white/10 px-4 py-2 lg:flex dark:bg-white/10",
  ...
  return (
    ...
    >
      <div className="flex items-center gap-2">
        {/* Decorative Icon */}
        {/* <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-gradient-to-br from-[#FFC300] to-[#FFA500] shadow-lg">
          <svg
            className="h-6 w-6 text-[#1F3A44]"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
            strokeWidth={2}
        ...
        {/* Arabic Logo Text with decorative Rakkas font */}
        <span 
          className="font-rakkas bg-gradient-to-r from-[#1F3A44] to-[#00B5AD] bg-clip-text text-3xl font-normal text-transparent dark:from-[#FFC300] dark:to-[#00B5AD]"
          style={{ 
